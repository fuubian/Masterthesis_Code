...
class InternVLModel(TextImageModel):
    def __init__(self, model_name="OpenGVLab/InternVL2-4B"):
    ...
    def generate_answer(self, question_prompt, image, max_answer_length=1024):
        ...
        generation_config = dict(max_new_tokens=max_answer_length, do_sample=True)

        model_response = self.model.chat(self.tokenizer, pixel_values, question_prompt + "\n<image>", generation_config)
